...
elixir(function(mix) {
    ...
    mix.task('build-spark-app')
      ...
      .browserify([
        './vendor/adnansyedimadi/react-spark/src/resources/assets/js/react-spark/react-spark.js',
        './vendor/adnansyedimadi/react-spark/src/resources/assets/js/react-spark/reactApp.js',
      ],
